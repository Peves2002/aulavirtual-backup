      ...
      >
        ...
        {rol === 'ADMIN' && (
          <>
            ...
            <MenuItem href='/admin/clientes' icon={<i className='tabler-building-community' />}>
              Clientes
            </MenuItem>
            ...
            <MenuItem href='/admin/capacitaciones' icon={<i className='tabler-presentation' />}>
              Capacitaciones
            </MenuItem>
            ...
            <MenuItem href='/admin/blogs' icon={<i className='tabler-news' />}>
              Blogs / Noticias
            </MenuItem>
