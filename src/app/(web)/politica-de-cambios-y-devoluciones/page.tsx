...
export const metadata = {
  title: 'Política de Cambios y Devoluciones | Master Academy',
}
      ...
      <Container maxWidth="md">
        ...
        <Box sx={{ '& h4': { color: 'var(--web-dark, #1A1A1A)', fontWeight: 800, mt: 5, mb: 2 }, '& p': { mb: 2, lineHeight: 1.8 } }}>
          ...
          <Typography paragraph>
            ...
            servicios educativos ofrecidos por <strong>Master Academy Grupo de Estudio S.A.C.</strong>,
            con RUC <strong>20611096627</strong>, con domicilio en Manzana D, Lote 43, APV El Manantial, San Martín de Porres, Lima — a través de su Academia Virtual. Al adquirir cualquier curso o simulacro,
          ...
          <Typography paragraph>
            Los cursos, simulacros y materiales ofrecidos en nuestra plataforma constituyen <strong>contenido digital de ejecución inmediata</strong>.
            ...
            material complementario del curso o simulacro adquirido.
          </Typography>
          ...
          <Typography paragraph>
            Esta condición es aplicable a todos los cursos, simulacros, rutas de aprendizaje, paquetes y materiales
          ...
          <Typography paragraph>
            1. Enviar un correo a <strong>Informes@mastergrupodeestudio.com</strong> con el asunto:{' '}
            <em>&quot;Solicitud de Reembolso — [Nombre del Curso/Simulacro]&quot;</em>.
          </Typography>
          <Typography paragraph>
          ...
          <Typography paragraph>
            Master Academy Grupo de Estudio S.A.C. se reserva el derecho de descontar las comisiones operativas
          ...
          <Typography paragraph>
            ...
            <strong>Informes@mastergrupodeestudio.com</strong> o por WhatsApp al <strong>+51 973 241 285</strong>. De acuerdo con la legislación de protección
            al consumidor vigente, también ponemos a su disposición nuestro{' '}
            <a href="/libro-de-reclamaciones" style={{ color: 'var(--web-primary, #D4AF37)', textDecoration: 'underline' }}>
