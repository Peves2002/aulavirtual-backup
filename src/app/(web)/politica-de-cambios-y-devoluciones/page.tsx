...
export const metadata = {
  title: 'Política de Cambios y Devoluciones | Coplimita',
}
      ...
      <Container maxWidth="md">
        ...
        <Box sx={{ '& h4': { color: 'var(--web-dark, #025E44)', fontWeight: 800, mt: 5, mb: 2 }, '& p': { mb: 2, lineHeight: 1.8 } }}>
          ...
          <Typography paragraph>
            ...
            servicios educativos ofrecidos por <strong>Coplimita</strong> —{' '}
            <strong>Coop Nuevo Mundo Sermul</strong>, con RUC <strong>20601400384</strong>,
            con domicilio en Jr. Alfonzo Peláez Bazán 240, Cajamarca, Perú — a través de su Aula Virtual.
            Al adquirir cualquier programa, el usuario declara haber leído y aceptado los términos aquí descritos.
          </Typography>
          ...
          <Typography paragraph>
            Los programas y materiales ofrecidos en nuestra plataforma constituyen <strong>contenido digital de ejecución inmediata</strong>.
            ...
            material complementario del programa adquirido.
          </Typography>
          ...
          <Typography paragraph>
            ...
            lección o acceder a cualquier material del programa, otorga su <strong>consentimiento expreso para el inicio
          ...
          <Typography paragraph>
            Esta condición es aplicable a todos los diplomados, especializaciones, programas de actualización
            y demás contenidos digitales disponibles en la plataforma.
          </Typography>
          ...
          <Typography paragraph>
            1. Enviar un correo a{' '}
            <strong>
              <a href="mailto:coplimitainstitute@gmail.com" style={{ color: 'var(--web-dark, #025E44)' }}>coplimitainstitute@gmail.com</a>
            </strong>{' '}
            con el asunto: <em>&quot;Solicitud de Reembolso — [Nombre del Programa]&quot;</em>.
          </Typography>
          <Typography paragraph>
            2. Adjuntar el comprobante de pago y número de pedido correspondiente.
          </Typography>
          <Typography paragraph>
            3. Nuestro equipo auditará los registros de acceso para verificar que el contenido no haya sido
            consumido antes de proceder con la evaluación de la solicitud.
          </Typography>

          <Typography variant="h4">5. Modalidad de Reembolso</Typography>
          <Typography paragraph>
            Si la solicitud es aprobada, el reembolso se gestionará a través de la pasarela de pago utilizada en la compra.
          ...
          <Typography paragraph>
            Coplimita — Coop Nuevo Mundo Sermul se reserva el derecho de descontar las comisiones operativas
          ...
          <Typography paragraph>
            📱 WhatsApp: <a href="https://wa.me/51931529171" style={{ color: 'var(--web-dark, #025E44)' }}>+51 931 529 171</a>
          </Typography>
          <Typography paragraph>
