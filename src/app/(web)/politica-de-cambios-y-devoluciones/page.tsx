...
export const metadata = {
  title: 'Política de Cambios y Devoluciones | ACE Consulting PERÚ',
}
      ...
      <Container maxWidth="md">
        ...
        <Box sx={{ '& h4': { color: 'var(--web-dark, #025E44)', fontWeight: 800, mt: 5, mb: 2 }, '& p': { mb: 2, lineHeight: 1.8 } }}>
          ...
          <Typography paragraph>
            ...
            servicios educativos ofrecidos por <strong>ACE Consulting PERÚ</strong>,
            con DNI <strong>07771730</strong> (Manuel Nieto Courrejolles), con domicilio en Calle Lino Alarco 212, Miraflores, Lima — a través de su Academia Virtual. Al adquirir cualquier curso o eBook,
          ...
          <Typography paragraph>
            1. Enviar un correo a <strong>aceconsultingperu@gmail.com</strong> con el asunto:{' '}
          ...
          <Typography paragraph>
            ACE Consulting PERÚ se reserva el derecho de descontar las comisiones operativas
          ...
          <Typography paragraph>
            ...
            <strong>aceconsultingperu@gmail.com</strong> o por WhatsApp al <strong>+51 920 184 072</strong>. De acuerdo con la legislación de protección
