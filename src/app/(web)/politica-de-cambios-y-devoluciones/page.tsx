...
export const metadata = {
  title: 'Política de Cambios y Devoluciones | Grupo Ollarves',
}
      ...
      <Container maxWidth="md">
        ...
        <Box sx={{ '& h4': { color: 'var(--web-dark, #025E44)', fontWeight: 800, mt: 5, mb: 2 }, '& p': { mb: 2, lineHeight: 1.8 } }}>
          ...
          <Typography paragraph>
            ...
            servicios educativos ofrecidos por <strong>GRUPO OLLARVES E.I.R.L.</strong>,
            con RUC <strong>20608467298</strong>, con domicilio en Octavio Muñoz Najar 128 - Segundo Piso, Arequipa, Perú
            — a través de su Aula Virtual. Al adquirir cualquier curso,
          ...
          <Typography paragraph>
            Esta condición es aplicable a todos los cursos, diplomados, programas, rutas de aprendizaje, paquetes y materiales
          ...
          <Typography paragraph>
            GRUPO OLLARVES E.I.R.L. se reserva el derecho de descontar las comisiones operativas
