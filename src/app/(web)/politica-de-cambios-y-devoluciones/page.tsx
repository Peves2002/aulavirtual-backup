...
export const metadata = {
  title: 'Política de Cambios y Devoluciones | INCUBA COCINA SAC',
}
      ...
      <Container maxWidth="md">
        ...
        <Box sx={{ '& h4': { color: 'var(--web-dark, #025E44)', fontWeight: 800, mt: 5, mb: 2 }, '& p': { mb: 2, lineHeight: 1.8 } }}>
          ...
          <Typography paragraph>
            ...
            servicios educativos ofrecidos por <strong>INCUBA COCINA SAC</strong>,
            con RUC <strong>20615725821</strong>, con domicilio en Jr. Neptuno 102 Los Olivos — a través de su Aula Virtual. Al adquirir cualquier curso,
          ...
          <Typography paragraph>
            1. Enviar un correo a <strong>incubacocina@gmail.com</strong> con el asunto:{' '}
          ...
          <Typography paragraph>
            INCUBA COCINA SAC se reserva el derecho de descontar las comisiones operativas
          ...
          <Typography paragraph>
            ...
            <strong>incubacocina@gmail.com</strong>. De acuerdo con la legislación de protección
