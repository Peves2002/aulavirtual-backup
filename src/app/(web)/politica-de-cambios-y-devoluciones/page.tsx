    ...
    <Box sx={{ bgcolor: 'white', py: { xs: 6, md: 10 }, color: '#333' }}>
      <Container maxWidth="md">
        ...
        <Box sx={{ '& h4': { color: 'var(--web-dark, #025E44)', fontWeight: 800, mt: 5, mb: 2 }, '& p': { mb: 2, lineHeight: 1.8 } }}>
          ...
          <Typography paragraph>
            1. Enviar un correo a <strong>informes@crececoncepav.com</strong> con el asunto:{' '}
          ...
          <Typography paragraph>
            ...
            <strong>informes@crececoncepav.com</strong>. De acuerdo con la legislación de protección
