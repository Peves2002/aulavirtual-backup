...
async function getData(token: string | null) {
  try {
    ...
    const data = await axiosWebCursos.getCatalog('PROGRAMA')
...
export const metadata = {
  title: 'Catálogo de Programas - Aula Virtual',
...
export default async function ProgramasPage() {
  ...
  return (
    <Box sx={{ flexGrow: 1, bgcolor: 'background.default' }}>
      ...
      >
        ...
        <Box sx={{ maxWidth: 1280, mx: 'auto', position: 'relative', zIndex: 1 }}>
          ...
          <Box
            ...
            component="p"
          >
            Explora nuestra selección de programas y comienza a aprender hoy.
          </Box>
      ...
      <CourseCatalog courses={courses} categories={categories} type="programa" />
    </Box>
  )
}
