...
export const metadata = {
  title: 'Términos y Condiciones | Grupo Ollarves',
}
      ...
      <Container maxWidth="md">
        ...
        <Box sx={{ '& h4': { color: 'var(--web-dark, #025E44)', fontWeight: 800, mt: 5, mb: 2 }, '& p': { mb: 2, lineHeight: 1.8 } }}>
          ...
          <Typography paragraph>
            Bienvenido a <strong>GRUPO OLLARVES E.I.R.L.</strong> (&quot;Nosotros&quot;, &quot;Grupo Ollarves&quot;), con RUC <strong>20608467298</strong>,
            domiciliada en Octavio Muñoz Najar 128 - Segundo Piso, Arequipa, Perú.
          ...
          <Typography paragraph>
            Grupo Ollarves brinda servicios de <strong>capacitación</strong> y <strong>consultoría</strong> dirigidos a profesionales de las diferentes especialidades y sectores económicos.
            Nuestra Aula Virtual contiene cursos, diplomados y programas orientados al desarrollo profesional y la formación continua.
          ...
          <Typography paragraph>
            Todos los pagos procesados en nuestro sitio web se gestionan a través de pasarelas de pago seguras (como <strong>IziPay</strong> o PayPal).
          ...
          <Typography paragraph>
            ...
            pertenece originariamente a GRUPO OLLARVES E.I.R.L. o a sus instructores afiliados.
          ...
          <Typography paragraph>
            ...
            indicados en cada curso (visualización al 100%, aprobación de evaluaciones, etc.). Grupo Ollarves se reserva
          ...
          <Typography paragraph>
            ...
            del registro (Ley de Protección de Datos Personales — Ley N° 29733 del territorio Peruano).
            Los datos se utilizan estrictamente para el servicio comercial del curso y fines facturativos,
            nunca serán cedidos a bases de datos de terceros. Consulte nuestra{' '}
