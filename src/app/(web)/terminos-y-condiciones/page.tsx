...
export const metadata = {
  title: 'Términos y Condiciones | MS&M CONSULTING',
}
      ...
      <Container maxWidth="md">
        ...
        <Box sx={{ '& h4': { color: 'var(--web-dark, #025E44)', fontWeight: 800, mt: 5, mb: 2 }, '& p': { mb: 2, lineHeight: 1.8 } }}>
          ...
          <Typography paragraph>
            Bienvenido a <strong>MS&M CONSULTING</strong> (RUC: 20606078499, con domicilio en Lima-San Martin de Porres-Lima - Residencial Montecarlo Mz N Lt 42 - I Etapa).
            Al acceder a nuestro sitio web y utilizar nuestros servicios de Aula Virtual, Consultoría y Capacitación,
          ...
          <Typography paragraph>
            MS&M CONSULTING brinda servicios de consultoría, gestión empresarial, sistemas de gestión en Seguridad y Salud en el Trabajo (SST), Salud Ocupacional y capacitaciones digitales.
          ...
          <Typography paragraph>
            Todos los pagos procesados en nuestro sitio web se gestionan a través de pasarelas de pago seguras (como IziPay, Culqi o PayPal).
          ...
          <Typography paragraph>
            ...
            pertenece originariamente a MS&M CONSULTING o a sus instructores afiliados.
          ...
          <Typography paragraph>
            ...
            indicados en cada curso (visualización al 100%, aprobación de evaluaciones, etc.). MS&M CONSULTING se reserva
          ...
          <Typography paragraph>
            ...
            del registro (Ley N° 29733 de Protección de Datos Personales).
          ...
          <Typography paragraph>
            Para consultas de soporte, comuníquese a través de nuestra página de <a href="/contacto" style={{ color: 'var(--web-dark, #025E44)', textDecoration: 'underline' }}>Contacto</a> o vía WhatsApp (+51 900 281 578 / +51 997 407 026).
