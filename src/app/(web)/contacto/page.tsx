...
import { ContactView } from './components/ContactoClient'

export const metadata = {
  title: 'Contáctanos - CEPAV',
  description: 'Ponte en contacto con el equipo de CEPAV para informes, dirección académica o comercial.',
}
        ...
        <div style={{ maxWidth: '720px', margin: '0 auto', position: 'relative', zIndex: 1, textAlign: 'center' }}>
          <ScrollReveal>
            ...
            <p style={{ ...sectionDesc, color: 'rgba(255,255,255,0.75)', textAlign: 'center', maxWidth: '480px', margin: '0 auto' }}>
              Estamos listos para resolver tus dudas y ayudarte a transformar tu carrera en el sector turismo.
            </p>
          </ScrollReveal>
        </div>
      </section>
