              ...
              return (
                <div key={servicio.slug} className="bg-white p-6 rounded-3xl shadow-lg border border-gray-100 transition-all hover:-translate-y-2 hover:shadow-xl group flex flex-col h-full">
                  ...
                  <div className="flex gap-3 mt-auto">
                    <Link href={`/servicios/${servicio.slug}`} className="flex-1 inline-flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl border-2 border-[var(--web-primary)] text-[var(--web-primary)] font-semibold text-sm no-underline hover:bg-[var(--web-primary)] hover:text-white transition-all">
                      Ver detalles
