      ...
      <div className="max-w-4xl mx-auto px-6 text-gray-800">
        ...
        <div className="space-y-8 leading-relaxed">
          <p>
            ...
            domicilio en Francisco Pizarro 312, Bellavista, Callao), valoramos su privacidad y nos comprometemos a proteger sus datos personales.
          ...
          <div>
            ...
            <p>
              Si tiene alguna pregunta o inquietud sobre nuestra Política de Privacidad o el tratamiento de sus datos personales, no dude en contactarnos a través de <strong>comercial@ifsec.pe</strong> o al <strong>993 492 895</strong>.
            </p>
          </div>
        </div>
      </div>
