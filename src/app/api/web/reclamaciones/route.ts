  ...
  try {
    ...
    const htmlContent = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
        <div style="background-color: #025E44; padding: 15px; border-radius: 6px 6px 0 0; text-align: center;">
        ...
        <div style="padding: 20px;">
          ...
          <div style="text-align: center; margin: 20px 0;">
            <span style="background-color: #f3f4f6; color: #025E44; padding: 10px 20px; font-size: 20px; font-weight: bold; border-radius: 4px; letter-spacing: 2px;">
              ${codigoReclamo}
            </span>
          </div>
        ...
        <div style="background-color: #f3f4f6; padding: 15px; text-align: center; border-radius: 0 0 6px 6px; font-size: 12px; color: #888;">
          ACE Consulting PERÚ — Manuel Nieto Courrejolles | DNI: 07771730 | aceconsultingperu@gmail.com
        </div>
      </div>
    `
