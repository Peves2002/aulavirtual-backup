...
export const generarModerno: GeneratorFn = async (data) => {
  ...
  doc.setFontSize(5); doc.setTextColor(255, 255, 255); doc.setFont('helvetica', 'normal')
  ...
  doc.line(ccx - 40, y, ccx + 40, y); y += 6

  // Subtítulo
  doc.setFontSize(8); doc.setFont('helvetica', 'normal'); doc.setTextColor(...MUTED)
  doc.text('ha completado satisfactoriamente el programa:', ccx, y, { align: 'center' }); y += 7
  ...
  // "Firmado el..."
  doc.setFontSize(8); doc.setFont('helvetica', 'normal'); doc.setTextColor(...MUTED)
  doc.text(`Lima, ${fechaFirmadaTxt}`, ccx, y, { align: 'center' }); y += 12
  ...
  doc.setFillColor(...BG); doc.rect(0, 0, W, H, 'F')
  doc.setFillColor(pr, pg, pb); doc.rect(0, 0, accentW, H, 'F')
  doc.setFillColor(...SURFACE); doc.rect(accentW, 0, W - accentW, H, 'F')
  ...
  // Col izquierda
  doc.setFillColor(pr, pg, pb); doc.roundedRect(cL, p2Y, cW2, 7, 1.5, 1.5, 'F')
...
return r !== null ? (r > 20 ? r / 5 : r) : null })()
  ...
  doc.setFontSize(T.b); doc.setFont('helvetica', 'normal'); doc.setTextColor(...MUTED)
  ...
  doc.setFillColor(pr, pg, pb); doc.roundedRect(cR, p2Y, cW2, 7, 1.5, 1.5, 'F')
  doc.setFontSize(T.h); doc.setFont('helvetica', 'bold'); doc.setTextColor(255, 255, 255)
