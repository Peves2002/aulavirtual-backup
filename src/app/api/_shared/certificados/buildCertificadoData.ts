...
type BuildCertificadoDataOptions = {
  ...
  inscripcion: { completado_en: Date | null; inscrito_en: Date; nota_final: number | null } | null
...
export async function buildCertificadoData(opts: BuildCertificadoDataOptions): Promise<CertificadoData> {
  const {
    certificado, configs, inscripcion, usuarioAvatar,
    intentosExamen, cursoFechaFin, reqUrl, previewFlag,
  } = opts
