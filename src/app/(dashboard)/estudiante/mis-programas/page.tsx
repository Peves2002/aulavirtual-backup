...
export default async function MyProgramasPage() {
    ...
    try {
        courses = await axiosMisCursos.getAll('PROGRAMA')
    } catch (error) {
        console.error('Error fetching inscribed programas via API:', error)
    }
                ...
                <Stack spacing={{ xs: 3, md: 4 }}>
                    <Box>
                        ...
                        <Typography variant="body1" color="text.secondary" sx={{ fontWeight: 500 }}>
                            Gestiona tu aprendizaje y sigue tu progreso en cada programa.
                        </Typography>
                    </Box>
