...
export const metadata = {
  title: 'Política de Cambios y Devoluciones | Elite Engineering',
}
    ...
    <Box sx={{ bgcolor: 'white', py: { xs: 6, md: 10 }, color: '#333' }}>
      <Container maxWidth="md">
        ...
        <Box sx={{ '& h4': { color: 'var(--web-dark, #025E44)', fontWeight: 800, mt: 5, mb: 2 }, '& p': { mb: 2, lineHeight: 1.8 } }}>
          ...
          <Typography variant="h4">3. Conditions para Solicitar Reembolso</Typography>
          <Typography paragraph>
          ...
          <Typography paragraph>
            1. Enviar un correo a <strong>gerencia@ingenierodeelite.com</strong> con el asunto:{' '}
          ...
          <Typography paragraph>
            Si la solicitud es aprobada, el reembolso se gestionará a través de la pasarela de pago <strong>Culqi</strong> o la pasarela correspondiente.
          ...
          <Typography paragraph>
            ELITE ENGINEERING E.I.R.L. se reserva el derecho de descontar las comisiones operativas
          ...
          <Typography paragraph>
            ...
            <strong>gerencia@ingenierodeelite.com</strong>. De acuerdo con la legislación de protección
