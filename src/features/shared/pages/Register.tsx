...
const Register = ({ mode }: { mode: SystemMode }) => {
  ...
  const darkIllustration = '/images/contenido/registro.jpg'
  const lightIllustration = '/images/contenido/registro.jpg'
  const borderedDarkIllustration = '/images/contenido/registro.jpg'
  const borderedLightIllustration = '/images/contenido/registro.jpg'
