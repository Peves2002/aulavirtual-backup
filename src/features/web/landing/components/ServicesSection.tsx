      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
          {services.map((service, index) => (
            ...
            >
              <div className="relative h-full flex flex-col glass-modern rounded-2xl p-5 transition-all duration-500 hover:-translate-y-2 hover:shadow-xl hover:border-primary/20 bg-white/70">
                <div className="w-12 h-12 rounded-2xl bg-primary flex items-center justify-center mb-4 group-hover:scale-110 group-hover:rotate-6 transition-all duration-500">
