...
export default function ServiceDetailClient({ service, waNumero }: ServiceDetailClientProps) {
  ...
  return (
    <div className='bg-slate-50 min-h-screen pb-24'>
      <AppModal open={Boolean(activeImage)} handleClose={() => setActiveImage(null)} sx={{ maxWidth: 960, p: 0 }}>
        {activeImage && (
          <div className='relative w-full overflow-hidden rounded-xl bg-slate-950'>
            <div className='relative h-[65vh] w-full sm:h-[75vh]'>
              <Image src={activeImage.src} alt={activeImage.title} fill className='object-contain' unoptimized />
            </div>
                    ...
                    {service.subServicios.map((sub, idx) => (
                      ...
                      >
                        ...
                        <div className='flex-1 flex flex-col justify-center gap-1'>
                          ...
                          {sub.desc && (
                            <p
                              className='text-xs text-slate-600 leading-relaxed sm:pl-6'
                              style={{ fontFamily: 'Poppins, sans-serif' }}
                            >
                              {sub.desc}
                            </p>
          ...
          <div className='lg:col-span-4'>
            <div className='sticky top-28 bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col gap-6'>
              ...
              <p className='text-xs text-slate-600 leading-relaxed' style={{ fontFamily: 'Poppins, sans-serif' }}>
                Habla directamente con nuestros ingenieros y especialistas para recibir una cotización a medida según
