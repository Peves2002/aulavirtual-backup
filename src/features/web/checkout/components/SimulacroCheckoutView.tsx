...
export default function SimulacroCheckoutView({ simulacro }: SimulacroCheckoutViewProps) {
  return (
    <Box sx={{ bgcolor: '#f8fafc', minHeight: 'calc(100vh - 64px)', fontFamily: FONT }}>
      {/* Mini hero */}
      <Box sx={{ background: 'linear-gradient(135deg, #0A0A0A 0%, #1A1A1A 45%, #111111 100%)', py: { xs: 4, md: 5 }, px: { xs: 3, md: 8, lg: 12 }, position: 'relative', overflow: 'hidden' }}>
        ...
        <Container maxWidth='lg' sx={{ position: 'relative', zIndex: 1 }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
            <Box sx={{ width: 48, height: 48, borderRadius: '14px', bgcolor: 'rgba(240,208,96,0.15)', border: '1px solid rgba(240,208,96,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
