    ...
    <Card elevation={0} sx={{ border: '1px solid #e0e0e0', borderRadius: 2, mb: 6 }}>
      <Box sx={{ bgcolor: '#f8f9fa', p: 3, borderBottom: '1px solid #e0e0e0', textAlign: 'center' }}>
        ...
        <Box sx={{ mt: 2, textAlign: 'left', bgcolor: 'white', p: 2, border: '1px solid #eee', borderRadius: 1 }}>
          <Typography variant="caption" display="block"><strong>PROVEEDOR:</strong> MS&M CONSULTING</Typography>
          <Typography variant="caption" display="block"><strong>RUC:</strong> 20606078499</Typography>
          <Typography variant="caption" display="block"><strong>DOMICILIO:</strong> Lima-San Martin de Porres-Lima - Residencial Montecarlo Mz N Lt 42 - I Etapa</Typography>
        </Box>
      </Box>
