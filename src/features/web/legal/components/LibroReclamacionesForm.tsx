    ...
    <Card elevation={0} sx={{ border: '1px solid #e0e0e0', borderRadius: 2, mb: 6 }}>
      <Box sx={{ bgcolor: '#f8f9fa', p: 3, borderBottom: '1px solid #e0e0e0', textAlign: 'center' }}>
        ...
        <Box sx={{ mt: 2, textAlign: 'left', bgcolor: 'white', p: 2, border: '1px solid #eee', borderRadius: 1 }}>
          <Typography variant="caption" display="block"><strong>PROVEEDOR:</strong> INCUBA COCINA SAC</Typography>
          <Typography variant="caption" display="block"><strong>RUC:</strong> 20615725821 </Typography>
          <Typography variant="caption" display="block"><strong>DOMICILIO:</strong> Jr. Neptuno 102 Los Olivos</Typography>
        </Box>
      </Box>
