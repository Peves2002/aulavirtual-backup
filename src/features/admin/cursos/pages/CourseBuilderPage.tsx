...
import { TabLandingPage } from '../components/CourseBuilder/TabLandingPage'
            ...
            <TabContext value={activeTab}>
                <Card>
                    <TabList onChange={(_, val) => setActiveTab(val)} variant='scrollable'>
                        ...
                        <Tab icon={<i className='tabler-star' />} iconPosition='start' label='Landing Page' value='4' />
                    ...
                    <TabPanel value='4' sx={{ p: 5 }}>
                        <TabLandingPage curso={curso} onSuccess={refetch} />
                    </TabPanel>
